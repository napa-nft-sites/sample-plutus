...
mkPolicy oref tn () ctx = traceIfFalse "UTxO not consumed"   hasUTxO           &&
  ...
  where
    ...
    -- If any of the transaction InfoOutRef from the transaction info inputs 
    -- from the transaction info field of the context 
    -- matches the UTxO for which we are validating 
